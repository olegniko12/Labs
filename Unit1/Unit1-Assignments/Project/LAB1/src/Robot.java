...
class Robot extends Canvas
{
   ...
   public void paint( Graphics window )
   {
      ...
      drawRobot(window, 350, 200, 100, 100, Color.BLACK, Color.YELLOW);
   ...
   public void drawSquare (Graphics window, int xValue, int yValue, int width, int height, Color color1, Color color2) {
	...
	public void drawRobot (Graphics window, int xValue, int yValue, int width, int height, Color color1, Color color2) {
		
		head(window, xValue, yValue, width, height, color1, color2);
		lowerBody(window, xValue, yValue, width, height, color1, color2);
		upperBody(window, xValue, yValue, width, height, color1, color2);
		
	}   

   public void upperBody(Graphics window, int xValue, int yValue, int width, int height, Color color1, Color color2)
   {
   ...
   public void lowerBody(Graphics window, int xValue, int yValue, int width, int height, Color color1, Color color2)
   {
